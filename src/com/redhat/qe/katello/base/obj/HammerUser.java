...
public class HammerUser extends _HammerObject {
	...
	public static final String ERR_INVALID_USER_PASS = 
	...
	public HammerUser(KatelloCliWorker kcr, String pName, String pEmail, String pPassword, boolean pDisabled, String pLocale){
		this.username = pName;
		this.email = pEmail;
		this.password = pPassword;
		this.disabled = pDisabled;
	...
	public HammerUser(KatelloCliWorker kcr, String pName,String pEmail,String pPassword,boolean pDisabled,String pOrgname,String pEnvname){
		this(kcr, pName,pEmail, pPassword, pDisabled);
		this.orgname = pOrgname;
		this.envname = pEnvname;
	}

	public HammerUser(KatelloCliWorker kcr, String pName,String pEmail,String pPassword,boolean pDisabled,String pOrgname,String pEnvname, Long id){
