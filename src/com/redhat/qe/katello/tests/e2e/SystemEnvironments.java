...
public class SystemEnvironments extends KatelloCliTestBase {
	...
	public void setUp(){
		...
		env = new KatelloEnvironment(this.cli_worker, env_name_Prod, null, org_name, KatelloEnvironment.LIBRARY);
		exec_result = env.cli_create();
		Assert.assertTrue(exec_result.getExitCode() == 0, "Check - return code (env create)");
		...
		this.contentView_name = KatelloUtils.promoteProductToEnvironment(cli_worker, this.org_name, product_name, env_name_Dev);
		KatelloContentView view = new KatelloContentView(cli_worker, this.contentView_name, org_name);
		...
		KatelloActivationKey act_key = new KatelloActivationKey(this.cli_worker, org_name, env_name_Dev, act_key_name,"Act key created");
	...
	public void test_installPackageOnMovedSystem() {
		...
		KatelloSystem sys = new KatelloSystem(this.cli_worker, system_name, this.org_name, env_name_Prod);
	...
	public void test_installPackageOnSystem() {
		KatelloSystem sys = new KatelloSystem(this.cli_worker, system_name, this.org_name, this.env_name_Prod);
