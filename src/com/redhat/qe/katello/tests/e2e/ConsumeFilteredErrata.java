...
public class ConsumeFilteredErrata extends KatelloCliTestBase {
	...
	public void setUp() {
		...
		repo = new KatelloRepo(this.cli_worker, repo_name,org_name,prod_name, REPO_HHOVSEPY_ZOO4, null, null);
	...
	public void test_consumeErrataContent() {
		...
		KatelloContentFilter filter = new KatelloContentFilter(cli_worker, errata_filter, org_name, condef_name);
