...
public class ArchitectureTests extends KatelloCliTestScript {
	...
	public void testArchitecture_create() {
		...
		Assert.assertTrue(getOutput(res).contains(String.format(KatelloArchitecture.OUT_CREATE, name)),"Check - returned output string");
	}
	...
	public void testArchitecture_createExists() {
		...
		Assert.assertTrue(getOutput(res).contains(String.format(KatelloArchitecture.ERR_NAME_EXISTS, name)),"Check - returned error string");
	}
	...
	public void testArchitecture_update() {
		...
		Assert.assertTrue(getOutput(res).contains(String.format(KatelloArchitecture.OUT_UPDATE, name)),"Check - returned output string");
	}
	...
	public void testArchitecture_infoNotFound() {
		...
		Assert.assertTrue(getOutput(res).contains(String.format(KatelloArchitecture.ERR_NOT_FOUND, name)),"Check - returned error string");
	}
	...
	public void testArchitecture_delete() {
		...
		Assert.assertTrue(getOutput(res).contains(String.format(KatelloArchitecture.OUT_DELETE, new_name)),"Check - returned output string");
	}
	...
	public void testArchitecture_updateNotFound() {
		...
		Assert.assertTrue(getOutput(res).contains(String.format(KatelloArchitecture.ERR_NOT_FOUND, new_name)),"Check - returned error string");
	}
