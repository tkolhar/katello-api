...
public interface KatelloConstants {
	...
	public static final String RPM_GRINDER_RHEL6 = "http://download.devel.redhat.com/brewroot/packages/grinder/0.1.16/1.el6sat/noarch/grinder-0.1.16-1.el6sat.noarch.rpm";
